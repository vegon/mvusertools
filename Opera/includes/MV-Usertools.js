...
window.opera.addEventListener("BeforeEvent.DOMContentLoaded", function() {
    ...
    var previousPageLink = window.jQuery(window.$(".tnext")).attr("href");
    var nextPageLink = window.jQuery(window.$(".tprev")).attr("href");
    ...
    var utTagsOpcion = window.localStorage["utTagsOpcion"];
    ...
    var utpatchnotes = '<p style="font-size: 16px; font-weight: bold;">Actualización ' + utversion + '</p><br /><br />																- ¡¡Tags!! Información de como funcionan en <a href="http://mvusertools.com/caracteristicas#tags" target="_blank">el apartado Características de la web oficial</a>.<br /><br />																- Pequeños añadidos.<br /><br />																- Corrección de errores.<br /><br />																';
    ...
    window.jQuery(function() {
        if (utTagsOpcion == "si" || utTagsOpcion == undefined) {
            ...
            window.jQuery(":not(form)> div.post > div.autor > dl > dt > a").each(function() {
                ...
                window.jQuery(this).closest(".autor").children(".ut_tag_info").on("submit", "form.ut_tag_form", function() {
                    var $tag = window.jQuery(this).children(".ut_tag_tag");
                    var $color = window.jQuery(this).children(".ut_tag_color");
                    var $link = window.jQuery(this).children(".ut_tag_link");
                    var $desc = window.jQuery(this).children(".ut_tag_desc");
                    var tag = $tag.val();
                    var color = $color.val();
                    if (color === "") {
                        var color = "#1392ED";
                    ...
                    if (utTags["" + nick + ""].tag !== "") {
                        window.jQuery(':not(form)> div.post > div.autor > dl > dt > a:contains("' + nick + '")').each(function() {
                            window.jQuery(this).closest(".autor").children(".ut_tag").replaceWith('<div class="ut_tag" style="background-color: ' + utTags[nick].color + '">' + utTags[nick].tag + "</div>");
                            window.jQuery(this).closest(".autor").children(".ut_tag_info").children(".ut_tag_form").children(".ut_tag_tag").attr("value", "" + utTags[nick].tag + "");
                            window.jQuery(this).closest(".autor").children(".ut_tag_info").children(".ut_tag_form").children(".ut_tag_color").attr("value", "" + utTags[nick].color + "");
                            window.jQuery(this).closest(".autor").children(".ut_tag_info").children(".ut_tag_form").children(".ut_tag_link").attr("value", "" + utTags[nick].link + "");
                            window.jQuery(this).closest(".autor").children(".ut_tag_info").children(".ut_tag_form").children(".ut_tag_link_span").replaceWith('<span class="ut_tag_link_span"><a href="' + utTags[nick].link + '" target="_blank">Link</a></span>');
                            window.jQuery(this).closest(".autor").children(".ut_tag_info").children(".ut_tag_form").children(".ut_tag_desc").text("" + utTags[nick].desc + "");
                            if (utTags[nick].link === "") {
                                window.jQuery(this).closest(".autor").children(".ut_tag_info").children(".ut_tag_form").children(".ut_tag_link_span").replaceWith('<span class="ut_tag_link_span">Link</span>');
                            }
                            window.jQuery(this).closest("div.autor").children(".ut_tag_info").hide();
                        });
                    } else {
                        window.jQuery(':not(form)> div.post > div.autor > dl > dt > a:contains("' + nick + '")').each(function() {
                            delete utTags["" + nick + ""];
                            window.jQuery(this).closest(".autor").children(".ut_tag").replaceWith('<div class="ut_tag ut_tag_vacia" style="background-color: #aaaaaa; opacity: 0.25; width: 9px; height: 15px; overflow: hidden;">+ etiqueta</div>');
                            window.jQuery(this).closest(".autor").children(".ut_tag_info").children(".ut_tag_form").replaceWith('<form class="ut_tag_form">&gt; Tag<br><input class="ut_tag_tag" placeholder="Tag" maxlength="11"><br />&gt; Color<div class="ut_tag_colores" style="display: inline;"><div class="ut_tag_colores_1"></div><div class="ut_tag_colores_2"></div><div class="ut_tag_colores_3"></div><div class="ut_tag_colores_4"></div><div class="ut_tag_colores_5"></div><div class="ut_tag_colores_6"></div></div><br><input class="ut_tag_color" placeholder="#5eadb9" maxlength="26"><br />&gt; <span class="ut_tag_link_span">Link</span><br><input class="ut_tag_link" placeholder="http://"><br />&gt; Descripción<br><textarea placeholder="Descripción" class="ut_tag_desc" style="width: 110px;"></textarea><br /><input type="submit" style="margin-top: 1px;" value="Guardar"></form>');
                            window.jQuery(this).closest("div.autor").children(".ut_tag_info").hide();
                        });
                    }
                    window.localStorage["ut-Tags"] = window.JSON.stringify(utTags);
            ...
            window.jQuery(".autor").each(function() {
                window.jQuery(this).on("click", ".ut_tag, .ut_tag_info_cerrar", function() {
                    window.jQuery(this).closest("div.autor").children(".ut_tag_info").toggle();
                });
            });
            window.jQuery(".autor").each(function() {
                window.jQuery(this).on("click", ".ut_tag_colores_1, .ut_tag_colores_2, .ut_tag_colores_3, .ut_tag_colores_4 , .ut_tag_colores_5, .ut_tag_colores_6 ", function() {
                    var color = window.jQuery(this).css("background-color");
                    window.jQuery(this).closest("div.ut_tag_colores").siblings(".ut_tag_color").attr("value", "" + color + "");
                });
            });
        }
    });
    ...
    if (utCambiosNombre == "si" || utCambiosNombre == undefined) {
        var utCambioDeNick = function(original, falso, ct) {
            window.jQuery('div.post div[class="autor"]:contains("' + original + '")').each(function() {
                window.jQuery(this).children().children("dt").children("a").text("" + falso + "");
                if (typeof ct !== "undefined") {
                    window.jQuery(this).children().children("dd:first").text("" + ct + "");
                }
            });
            window.jQuery(document).on("mouseover", "body", function() {
                window.jQuery('div.lastpost cite a:contains("' + original + '")').text("" + falso + "");
            });
            window.jQuery('tr div.left a[href^="/id/"]:contains("' + original + '")').each(function() {
                window.jQuery(this).text("" + falso + "");
            });
        };
        ...
        var utCambioDeNombreForo = function(original, falso) {
            window.jQuery('div.fpanels div.fpanel div.info span.sub a:contains("' + original + '")').text("" + falso + "");
            window.jQuery('#topnav h1:contains("' + original + '")').text("" + falso + "");
            window.jQuery('#topnav a:contains("' + original + '")').text("" + falso + "");
            window.jQuery('#footnav a:contains("' + original + '")').text("" + falso + "");
            window.jQuery('div.fpanels div.fpanel div.info strong a:contains("' + original + '")').text("" + falso + "");
        };
